...
CREATE TABLE fcode (
    ...
    code character varying(5) UNIQUE NOT NULL,
    name character varying(128) NOT NULL,
    description text NOT NULL
);

COPY fcode (feature_class, code, name, description) FROM STDIN;
X	UNK	Unknown	a feature of unknown type
A	ADM3	third-order administrative division	a subdivision of a third-order administrative division
A	ADM4	fourth-order administrative division	a subdivision of a fourth-order administrative division
...
A	ADM2	county	a subdivision of a second-order administrative division
H	BGHT	bight	an open body of water forming a slight recession in a coastline
...
S	MTRO	metro station	metro station (Underground, Tube, or M?tro) 
...
H	LBED	lake bed	a dried up or drained area of a former lake
...
S	TMB	tomb	a structure for interring bodies
...
A	ADM1	state	a primary administrative division of a country, such as a state in the United States
H	BNK	bank	an elevation, typically located on a shelf, over which the depth of water is relatively shallow but sufficient for most surface navigation
H	BOG	bog	a wetland characterized by peat forming sphagnum moss, sedge, and other acid-water plants
H	CHNL	lake channel	that part of a lake having water deep enough for navigation between islands, shoals, etc.
H	CNLN	navigation canal	a watercourse constructed for navigation of vessels
H	CNLSB	underground irrigation canal	a gently inclined underground tunnel bringing water for irrigation from aquifers
H	COVE	cove	a small coastal indentation, smaller than a bay
H	CRKT	tidal creek	a meandering channel in a coastal wetland subject to bi-directional tidal currents
H	DCK	dock	a waterway between two piers, or cut into the land for the berthing of ships
H	DTCHM	ditch mouth	an area where a drainage ditch enters a lagoon, lake or bay
H	FLLS	waterfall	a perpendicular or very steep descent of the water of a stream
H	FLTM	mud flat	a relatively level area of mud either between high and low tide lines, or subject to flooding
H	FLTT	tidal flat	a large flat area of mud or sand attached to the shore and alternately covered and uncovered by the tide
H	GLCR	glacier	a mass of ice, usually at high latitudes or high elevations, with sufficient thickness to flow away from the source area in lobes, tongues, or masses
H	HBR	harbor	a haven or space of deep water so sheltered by the adjacent land as to afford a safe anchorage for ships
H	MOOR	moor	an area of open ground overlaid with wet peaty soils
H	MRSH	marsh	a wetland dominated by grass-like vegetation
H	POOL	pool	a small and comparatively still, deep part of a larger body of water such as a stream or harbor; or a small body of standing water
H	RF	reef	a surface-navigation hazard composed of consolidated material
H	RFC	coral reef	a surface-navigation hazard composed of coral
H	RSV	reservoir	an artificial pond or lake
H	RVN	ravine	a small, narrow, deep, steep-sided stream channel, smaller than a gorge
H	SBKH	sabkha	a salt flat or salt encrusted plain subject to periodic inundation from flooding or high tides
H	SHOL	shoal	a surface-navigation hazard composed of unconsolidated material
H	SPNG	spring	a place where ground water flows naturally out of the ground
H	SPNS	sulphur spring	a place where sulphur ground water flows naturally out of the ground
H	SPNT	hot spring	a place where hot ground water flows naturally out of the ground
H	STMD	distributary	a branch which flows away from the main stream, as in a delta or irrigation canal
H	STMM	stream mouth	a place where a stream discharges into a lagoon, lake, or the sea
H	WTRH	waterhole	a natural hole, hollow, or small depression that contains water, used by man and animals, especially in arid areas
L	FLD	field	an open as opposed to wooded area
L	FLDI	irrigated field	a tract of level or terraced land which is irrigated
L	OAS	oasis	an area in a desert made productive by the availability of water
S	BLDG	building	a structure built for permanent use, as a house, factory, etc.
S	BUR	burial cave	a cave used for human burials
S	CAVE	cave	an underground passageway or chamber, or cavity on the side of a cliff
S	CMP	camp	a site occupied by tents, huts, or other shelters for temporary use
S	CRRL	corral	a pen or enclosure for confining or capturing animals
S	EST	estate	a large commercialized agricultural landholding with associated buildings and other facilities
S	GDN	garden	an enclosure for displaying selected plant or animal life
S	HSE	house	a building used as a human habitation
S	LOCK	lock	a basin in a waterway with gates at each end by means of which vessels are passed from one water level to another
S	ML	mill	a building housing machines for transforming, shaping, finishing, grinding, or extracting products
S	MN	mine	a site where mineral ores are extracted from the ground by excavating surface pits and subterranean passages
T	CRTR	crater	a generally circular saucer or bowl-shaped depression caused by volcanic or meteorite explosive action
T	CUET	cuesta	an asymmetric ridge formed on tilted strata
T	DPR	depression	a low area surrounded by higher land and usually characterized by interior drainage
T	DUNE	dune	a wave form, ridge or star shape feature composed of sand
T	FAN	fan	a fan-shaped wedge of coarse alluvium with apex merging with a mountain stream bed and the fan spreading out at a low angle slope onto an adjacent plain
T	GRGE	gorge	a short, narrow, steep-sided section of a stream valley
T	HMCK	hammock	a patch of ground, distinct from and slightly above the surrounding plain or wetland. Often occurs in groups
T	MESA	mesa	a flat-topped, isolated elevation with steep slopes on all sides, less extensive than a plateau
T	MND	mound	a low, isolated, rounded hill
T	PLN	plain	an extensive area of comparatively level to gently undulating land, lacking surface irregularities, and usually adjacent to a higher area
T	PROM	promontory	a bluff or prominent hill overlooking or projecting into a lowland
T	RDGE	ridge	a long narrow elevation with steep sides, and a more or less continuous crest
T	SLP	slope	a surface with a relatively uniform slope angle
T	SPUR	spur	a subordinate ridge projecting outward from a hill, mountain or other elevation
T	TRGD	interdune trough	a long wind-swept trough between parallel longitudinal dunes
U	ESCU	escarpment	an elongated and comparatively steep slope separating flat or gently sloping areas
U	TMSU	tablemounts	seamounts having a comparatively smooth, flat top
U	TMTU	tablemount	a seamount having a comparatively smooth, flat top
V	BUSH	bush	a small clump of conspicuous bushes in an otherwise bare area
V	FRST	forest	an area dominated by tree vegetation
V	OCH	orchard	a planting of fruit or nut trees
V	TREE	tree	a conspicuous tree used as a landmark
S	MNAU	gold mine	a mine where gold ore, or alluvial gold is extracted
S	MNC	coal mine	a mine where coal is extracted
S	MNCR	chrome mine	a mine where chrome ore is extracted
S	MNCU	copper mine	a mine where copper ore is extracted
S	MNFE	iron mine	a mine where iron ore is extracted
S	MNN	salt mine	a mine from which salt is extracted
S	MNQR	quarry	a surface mine where building stone or gravel and sand, etc. are extracted
S	NSY	nursery	a place where plants are propagated for transplanting or grafting
S	RNCH	ranch	a large farm specializing in extensive grazing of livestock
S	RUIN	ruin	a destroyed or decayed structure which is no longer functional
S	TMPL	temple	an edifice dedicated to religious worship
S	WEIR	weir	a small dam in a stream, designed to raise the water level or to divert stream flow through a desired channel
S	WHRF	wharf	a structure of open rather than solid construction along a shore or a bank which provides berthing for ships and cargo-handling facilities
T	ATOL	atoll	a ring-shaped coral reef which has closely spaced islands on it encircling a lagoon
T	BLHL	blowhole	a hole in coastal rock through which sea water is forced by a rising tide or waves and spurted through an outlet into the air
T	BLOW	blowout	a small depression in sandy terrain, caused by wind erosion
T	BUTE	butte	a small, isolated, usually flat-topped hill with steep sides
T	CFT	cleft	a deep narrow slot, notch, or groove in a coastal cliff
T	CLF	cliff	a high, steep to perpendicular slope overlooking a waterbody or lower area
T	CONE	cone	a conical landform composed of mud or volcanic material
\.
